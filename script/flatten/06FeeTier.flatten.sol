...
pragma solidity =0.8.23 ^0.8.1 ^0.8.2;
...
// src/libraries/FeeTiersUtils.sol
...
// src/core/facets/GNSFeeTiers.sol
...
contract GNSFeeTiers is GNSAddressStore, IFeeTiersUtils {
    ...
    /// @inheritdoc IFeeTiersUtils
    function setFeeTiers(uint256[] calldata _feeTiersIndices, IFeeTiers.FeeTier[] calldata _feeTiers)
        external
        onlyRole(Role.GOV)
    {
