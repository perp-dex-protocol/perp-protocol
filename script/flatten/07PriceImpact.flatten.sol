...
pragma solidity =0.8.23 >=0.4.19 ^0.8.0 ^0.8.1 ^0.8.2;
...
// src/interfaces/IGNSDiamondLoupe.sol
...
// src/interfaces/IGNSStaking.sol
...
// src/interfaces/IGeneralErrors.sol
...
// src/interfaces/libraries/ITradingCommonUtils.sol
...
// src/interfaces/mock/IBlockManager_Mock.sol
...
// src/interfaces/types/IAddressStore.sol
...
// src/interfaces/types/IBorrowingFees.sol
...
// src/interfaces/types/IDiamondStorage.sol
...
// src/interfaces/types/IFeeTiers.sol
...
// src/interfaces/types/IPairsStorage.sol
...
// src/interfaces/types/IPriceImpact.sol
...
// src/interfaces/types/IReferrals.sol
...
// src/interfaces/types/ITradingInteractions.sol
...
// src/interfaces/types/ITradingStorage.sol
...
// src/interfaces/types/ITriggerRewards.sol
...
// src/interfaces/types/IUpdateLeverage.sol
...
// src/interfaces/types/IUpdatePositionSize.sol
...
// src/libraries/StorageUtils.sol
...
// src/interfaces/IGNSDiamondCut.sol
...
// src/interfaces/libraries/IBorrowingFeesUtils.sol
...
// src/interfaces/libraries/IFeeTiersUtils.sol
...
interface IFeeTiersUtils is IFeeTiers {
     ...
     */
    function setFeeTiers(uint256[] calldata _feeTiersIndices, IFeeTiers.FeeTier[] calldata _feeTiers) external;
     ...
     */
    function getFeeTier(uint256 _feeTierIndex) external view returns (IFeeTiers.FeeTier memory);
     ...
     * @param _trader trader address
     */
    function getFeeTiersTraderInfo(address _trader) external view returns (IFeeTiers.TraderInfo memory);
...
// src/interfaces/libraries/IPairsStorageUtils.sol
...
// src/interfaces/libraries/IPriceImpactUtils.sol
...
// src/interfaces/libraries/IReferralsUtils.sol
...
// src/interfaces/libraries/ITradingStorageUtils.sol
...
// src/interfaces/libraries/ITriggerRewardsUtils.sol
...
// src/interfaces/types/ITradingCallbacks.sol
...
// src/libraries/ConstantsUtils.sol
 ...
 */
interface IERC20_1 is IERC20Metadata {
...
// src/interfaces/IGNSAddressStore.sol
...
// src/libraries/AddressStoreUtils.sol
...
// src/interfaces/libraries/IUpdateLeverageUtils.sol
...
// src/interfaces/libraries/IUpdatePositionSizeUtils.sol
...
library CollateralUtils {
    ...
    function getCollateralConfig(address _token) internal view returns (CollateralConfig memory _meta) {
        uint256 _decimals = uint256(IERC20_1(_token).decimals());
...
// src/interfaces/types/IPriceAggregator.sol
...
// src/core/abstract/GNSAddressStore.sol
...
// src/libraries/PairsStorageUtils.sol
...
// src/interfaces/libraries/ITradingCallbacksUtils.sol
...
// src/interfaces/libraries/ITradingInteractionsUtils.sol
...
// src/interfaces/libraries/IPriceAggregatorUtils.sol
...
// src/interfaces/types/ITypes.sol
...
// src/interfaces/IGNSDiamond.sol
...
// src/interfaces/IGNSMultiCollatDiamond.sol
...
// src/libraries/TradingCallbacksUtils.sol
...
// src/libraries/TradingCommonUtils.sol
...
library TradingCommonUtils {
    ...
    function transferCollateralFrom(uint8 _collateralIndex, address _from, uint256 _amountCollateral) public {
        if (_amountCollateral > 0) {
            IERC20_1(_getMultiCollatDiamond().getCollateral(_collateralIndex).collateral).safeTransferFrom(
    ...
    function transferCollateralTo(uint8 _collateralIndex, address _to, uint256 _amountCollateral) public {
        if (_amountCollateral > 0) {
            IERC20_1(_getMultiCollatDiamond().getCollateral(_collateralIndex).collateral).safeTransfer(
...
// src/libraries/updateLeverage/UpdateLeverageLifecycles.sol
...
library UpdateLeverageLifecycles {
     ...
     */
    function requestUpdateLeverage(IUpdateLeverage.UpdateLeverageInput memory _input) external {
    ...
    function executeUpdateLeverage(
        ...
        IUpdateLeverage.UpdateLeverageValues memory values =
     ...
     */
    function _validateRequest(IUpdateLeverage.UpdateLeverageInput memory _input)
        internal
        view
    ...
    function _prepareCallbackValues(
        ...
        bool _isIncrease
    ) internal view returns (IUpdateLeverage.UpdateLeverageValues memory values) {
...
// src/libraries/updatePositionSize/DecreasePositionSizeUtils.sol
...
library DecreasePositionSizeUtils {
    ...
    function validateRequest(
        ITradingStorage.Trade memory _trade,
        IUpdatePositionSize.DecreasePositionSizeInput memory _input
    ...
    function prepareCallbackValues(
        ...
        ITradingCallbacks.AggregatorAnswer memory _answer
    ) internal view returns (IUpdatePositionSize.DecreasePositionSizeValues memory values) {
    ...
    function validateCallback(
        ITradingStorage.Trade memory _existingTrade,
        IUpdatePositionSize.DecreasePositionSizeValues memory _values,
        ITradingCallbacks.AggregatorAnswer memory _answer
...
// src/libraries/updatePositionSize/IncreasePositionSizeUtils.sol
...
library IncreasePositionSizeUtils {
    ...
    function validateRequest(
        ITradingStorage.Trade memory _trade,
        IUpdatePositionSize.IncreasePositionSizeInput memory _input
    ) internal view returns (uint256 positionSizeCollateralDelta) {
    ...
    function prepareCallbackValues(
        ...
        ITradingStorage.Trade memory _partialTrade,
        ITradingCallbacks.AggregatorAnswer memory _answer
    ) internal view returns (IUpdatePositionSize.IncreasePositionSizeValues memory values) {
    ...
    function validateCallback(
        ITradingStorage.Trade memory _existingTrade,
        IUpdatePositionSize.IncreasePositionSizeValues memory _values,
        ITradingCallbacks.AggregatorAnswer memory _answer,
...
// src/libraries/updatePositionSize/UpdatePositionSizeLifecycles.sol
...
library UpdatePositionSizeLifecycles {
     ...
     */
    function requestIncreasePositionSize(IUpdatePositionSize.IncreasePositionSizeInput memory _input) external {
        // 1. Base validation
     ...
     */
    function requestDecreasePositionSize(IUpdatePositionSize.DecreasePositionSizeInput memory _input) external {
        // 1. Base validation
        ITradingStorage.Trade memory trade = _baseValidateRequest(_input.user, _input.index);
    ...
    function executeIncreasePositionSizeMarket(
        ...
        IUpdatePositionSize.IncreasePositionSizeValues memory values;
    ...
    function executeDecreasePositionSizeMarket(
        ...
        ITradingStorage.Trade memory existingTrade =
            _getMultiCollatDiamond().getTrade(partialTrade.user, partialTrade.index);
        IUpdatePositionSize.DecreasePositionSizeValues memory values;
...
// src/libraries/TradingStorageUtils.sol
...
library TradingStorageUtils {
    ...
    function addCollateral(address _collateral, address _gToken) public {
        ...
        IERC20_1 collateral = IERC20_1(_collateral);
...
// src/libraries/PriceImpactUtils.sol
...
// src/core/facets/GNSPriceImpact.sol
